    ...
    <div className="flex flex-col md:flex-row items-center bg-white rounded-lg shadow-lg p-4 gap-4 border mt-5">
      ...
      <div className="flex-1">
        <div className="flex flex-col md:flex-row gap-5 lg:gap-0 justify-between ">
          <h3 className="text-2xl text-[#242424] leading-6 font-bold align-text-bottom line-clamp-1 ">
            {title}
          </h3>
          <div className="flex gap-6 items-center">
            ...
            <button
              ...
              className="bg-orange-400 text-white px-4 py-2 rounded-lg text-base font-satoshi hover:bg-[#0037ff] transition-colors duration-300 ease-in-out"
            >
              Reserve now
            </button>
          </div>
